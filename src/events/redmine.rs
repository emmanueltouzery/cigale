...
impl Redmine {
    ...
    fn redmine_locales() -> HashMap<&'static str, LocaleInfo> {
        ...
        locales.insert("lv", LocaleInfo::new("%d.%m.%Y", "šodien"));
        locales.insert("th", LocaleInfo::new("%Y-%m-%d", "วันนี้"));
        locales.insert("zh", LocaleInfo::new("%Y-%m-%d", "今天"));
        locales.insert("da", LocaleInfo::new("%d.%m.%Y", "i dag"));
        locales.insert("pt", LocaleInfo::new("%d/%m/%Y", "hoje"));
        locales.insert("ja", LocaleInfo::new("%Y/%m/%d", "今日"));
        locales.insert("pl", LocaleInfo::new("%Y-%m-%d", "dzisiaj"));
        locales.insert("lt", LocaleInfo::new("%m/%d/%Y", "šiandien"));
        locales.insert("fa", LocaleInfo::new("%Y/%m/%d", "امروز"));
        locales.insert("gl", LocaleInfo::new("%e/%m/%Y", "hoxe"));
        locales.insert("uk", LocaleInfo::new("%Y-%m-%d", "сьогодні"));
        locales.insert("vi", LocaleInfo::new("%d-%m-%Y", "hôm nay"));
        locales.insert("mn", LocaleInfo::new("%Y/%m/%d", "өнөөдөр"));
        locales.insert("cs", LocaleInfo::new("%Y-%m-%d", "dnes"));
        locales.insert("en-GB", LocaleInfo::new("%d/%m/%Y", "today"));
        locales.insert("fr", LocaleInfo::new("%d/%m/%Y", "aujourd'hui"));
        locales.insert("sr", LocaleInfo::new("%d.%m.%Y.", "данас"));
        locales.insert("fi", LocaleInfo::new("%e. %Bta %Y", "tänään"));
        locales.insert("no", LocaleInfo::new("%d.%m.%Y", "idag"));
        locales.insert("mk", LocaleInfo::new("%d/%m/%Y", "денес"));
        locales.insert("hu", LocaleInfo::new("%Y.%m.%d.", "ma"));
        locales.insert("ro", LocaleInfo::new("%d-%m-%Y", "astăzi"));
        locales.insert("it", LocaleInfo::new("%d-%m-%Y", "oggi"));
        locales.insert("he", LocaleInfo::new("%d/%m/%Y", "היום"));
        locales.insert("es", LocaleInfo::new("%Y-%m-%d", "hoy"));
        locales.insert("en", LocaleInfo::new("%m/%d/%Y", "today"));
        locales.insert("sq", LocaleInfo::new("%m/%d/%Y", "sot"));
        locales.insert("eu", LocaleInfo::new("%Y/%m/%d", "gaur"));
        locales.insert("id", LocaleInfo::new("%d-%m-%Y", "hari ini"));
        locales.insert("de", LocaleInfo::new("%d.%m.%Y", "heute"));
        locales.insert("bg", LocaleInfo::new("%d-%m-%Y", "днес"));
        locales.insert("sv", LocaleInfo::new("%Y-%m-%d", "idag"));
        locales.insert("sk", LocaleInfo::new("%Y-%m-%d", "dnes"));
        locales.insert("ko", LocaleInfo::new("%Y/%m/%d", "오늘"));
        locales.insert("et", LocaleInfo::new("%d.%m.%Y", "täna"));
        locales.insert("hr", LocaleInfo::new("%m/%d/%Y", "danas"));
        locales.insert("el", LocaleInfo::new("%m/%d/%Y", "σήμερα"));
        locales.insert("zh-TW", LocaleInfo::new("%Y-%m-%d", "今天"));
        locales.insert("sr-YU", LocaleInfo::new("%d.%m.%Y.", "danas"));
        locales.insert("bs", LocaleInfo::new("%d.%m.%Y", "danas"));
        locales.insert("tr", LocaleInfo::new("%d.%m.%Y", "bugün"));
        locales.insert("ru", LocaleInfo::new("%d.%m.%Y", "сегодня"));
        locales.insert("es-PA", LocaleInfo::new("%Y-%m-%d", "hoy"));
        locales.insert("ar", LocaleInfo::new("%m/%d/%Y", "اليوم"));
        locales.insert("sl", LocaleInfo::new("%d.%m.%Y", "danes"));
        locales.insert("az", LocaleInfo::new("%d.%m.%Y", "bu gün"));
        locales.insert("ca", LocaleInfo::new("%d-%m-%Y", "avui"));
        locales.insert("pt-BR", LocaleInfo::new("%d/%m/%Y", "hoje"));
        locales.insert("nl", LocaleInfo::new("%d-%m-%Y", "vandaag"));
        locales
    }
